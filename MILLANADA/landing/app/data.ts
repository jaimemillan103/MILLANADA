...
export const recapPhotoIds = [
  '1dbyTZrsGhfgqP2TMFjDwtw-syhrKkwDW',
  '1sGbDv8wV0tnOsw9XV9fWlA3yZvBMB-IG',
  '17S8CutzHnSfQ_xYSYCdeg5KuNtUd4unK',
  '1KC4mw8l-G_uP61AwKT3jv6C2e7-cpxqD',
  '1WIirFOqu1p25iAsmDNMUotJmKgk3WiV1',
  '1xMOxTpUFjd00gUjLDVmbaDA1z0Qw6Yko',
  '1Jr1I67S_uYI-ScYVwAM_R5L5a7d1DFFd',
  '1LBUCQEQ2tyc9EFnJ6IQRIAMJMH_jG97A',
  '1JflCHSeC7MQ4uH8iPMf5tJbH5hjsa-Ol',
  '1vDjXn906qtAesJ19KvH1s3YnJI3Fd_ZY',
  '1-8lKTJjjJyqkJn9mfmeOenwkwDbEzm3v',
  '1vYhCMBkM2TqQeSGDlZKmWOnuxl4NUliP',
  '1T5XAI2PU8BfWYlGfzdLpyV1jNVg3DNeW',
  '1TZwHn5txHtGdrWsJ9-VSKwquBw_ea1kr',
  '1UCYTPBveFhN8829y7K31iyznOcMGm5fm',
];

export const recapPhotos = recapPhotoIds.map((id, index) => ({
  id,
